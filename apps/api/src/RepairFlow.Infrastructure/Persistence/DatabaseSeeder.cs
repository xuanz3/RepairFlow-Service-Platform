...
public static class DatabaseSeeder
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        await EnsurePhase3SchemaAsync(database, cancellationToken);
    ...
    private static async Task EnsurePhase3SchemaAsync(
        RepairFlowDbContext database,
        CancellationToken cancellationToken)
    {
        if (!string.Equals(
        ...
        await database.Database.ExecuteSqlRawAsync(
            ...
            CREATE INDEX IF NOT EXISTS "IX_sync_operations_ActorId_CreatedAt"
                ON sync_operations ("ActorId", "CreatedAt");
            ...
            CREATE INDEX IF NOT EXISTS "IX_sync_changes_EntityType_EntityId_Id"
                ON sync_changes ("EntityType", "EntityId", "Id");

            CREATE TABLE IF NOT EXISTS attachment_upload_sessions (
                "Id" uuid PRIMARY KEY,
                "RepairCaseId" uuid NOT NULL,
            ...
            CREATE INDEX IF NOT EXISTS "IX_attachment_upload_sessions_RepairCaseId_State_UpdatedAt"
                ON attachment_upload_sessions ("RepairCaseId", "State", "UpdatedAt");
            """,
            cancellationToken);
    }
